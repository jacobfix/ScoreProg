...
public class GameActivity extends AppCompatActivity implements SyncFinishedListener,
    ...
    public void onSyncFinished() {
        Log.d(TAG, "onSyncFinished() called in GameActivity");
        ...
        // Toast.makeText(this, GameActivity.class.getSimpleName() + ": Data set updated for " + mGame.getGameId(), Toast.LENGTH_SHORT).show();
    }
