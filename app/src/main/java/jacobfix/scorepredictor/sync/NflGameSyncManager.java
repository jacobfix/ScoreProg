...
import jacobfix.scorepredictor.server.LocalDataRetriever;
import jacobfix.scorepredictor.server.NflWebsiteDataRetriever;
...
public class NflGameSyncManager {
    ...
    public void startScheduledSync(SyncFinishedListener listener) {
        mSyncFinishedListener = listener;
        if (!mRunning) {
    ...
    public void stopScheduledSync(SyncFinishedListener listener) {
    ...
    public void setListener(SyncFinishedListener listener) {
        mSyncFinishedListener = listener;
    }
