...
public class OriginalGamePagerAdapter extends FragmentStatePagerAdapter {

    private static final String TAG = OriginalGamePagerAdapter.class.getSimpleName();
    ...
    public OriginalGamePagerAdapter(FragmentManager fm) {
        super(fm);
