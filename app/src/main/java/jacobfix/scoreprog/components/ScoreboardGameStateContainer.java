...
public class ScoreboardGameStateContainer extends LinearLayout {
    ...
    // private static final SimpleDateFormat TIME_AND_DATE_FORMAT = new SimpleDateFormat("h:mm a~E, M/d", Locale.US);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        clock.setTypeface(FontHelper.getArimoRegular(getContext()));
        quarter.setTypeface(FontHelper.getArimoRegular(getContext()));
