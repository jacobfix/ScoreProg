...
public class OriginalPlayFeedFragment extends Fragment {

    private static final String TAG = OriginalPlayFeedFragment.class.getSimpleName();
    ...
    public static OriginalPlayFeedFragment newInstance() {
        return new OriginalPlayFeedFragment();
    }
    ...
    public void onAttach(Context context) {
        ...
        // mPlayFeed = mGame.getDriveFeed().getDriveFeed();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((ListView) ViewUtil.findById(view, R.id.list)).setAdapter(mPlayFeedAdapter);
        mInflater = inflater;
        return view;
    }
